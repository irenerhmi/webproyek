                ...
                <div class="breadcrumb-content section-fluid-270">
                    <div class="breadcrumb-wrapper">
                        <div class="content">
                            ...
                            <h2 class="title"><span class="text-mark">Produk Hot Deals</span> Page</h2>
                        </div>
                        <ul class="breadcrumb-nav">
                            <li><a href="shop-grid-sidebar-left.html">Shop</a></li>
                            <li>Produk Hot Deals</li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xl-8 offset-xl-1 col-lg-9">
                            <ul class="product-shop-filter-info">
                                <li class="prduct-item-traking">
                                    <span>
                                        Showing 
                                        <?php
                                        $sql = "SELECT count(id_produk) as jumlahprod from produk where p_flag=1 order by id_produk desc";
                            ...
                            <div class="product-shop-list-items">
                                <div class="row mb-n25">
                                    ...
                                    $result = mysqli_query($conn, "SELECT * FROM produk where p_flag=1");
                                    $total = mysqli_num_rows($result);

                                    $pages = ceil($total/$perpage);

                                    $ambil = $conn->query("SELECT * from produk where p_flag = 1 "); ?>
