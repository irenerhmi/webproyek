                        ...
                        <div class="col-xl-8 offset-xl-1 col-lg-9">
                            <ul class="product-shop-filter-info">
                                <li class="prduct-item-traking">
                                    <span>
                                        Showing 
                                        <?php
                                        $sql = "SELECT count(id_produk) as jumlahprod from produk where status='PO' AND p_flag=1 order by id_produk desc";
                            ...
                            <div class="product-shop-list-items">
                                <div class="row mb-n25">
                                    ...
                                    $result = mysqli_query($conn, "SELECT * FROM produk where status='PO' AND p_flag=1");
                                    $total = mysqli_num_rows($result);

                                    $pages = ceil($total/$perpage);

                                    $ambil = $conn->query("SELECT * from produk where p_flag = 1 AND status='PO'"); ?>
