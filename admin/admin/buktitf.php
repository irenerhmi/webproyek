                                    ...
                                    <div class="card">
                                      <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                        <div class="card-body">
                                            ...
                                            <p><img src="assets/img/<?=$bukti; ?>" width="300"></p><br><br>
                                            <span>
                                                <a href="batalkan.php?id=<?php echo $id_transaksi; ?>"onclick= "return confirm('yakin?');"   class="btn btn-danger"><i class="fa fa-times" aria-hidden="true"></i> Batalkan</a>
                                                <a href="confirm.php?id=<?php echo $id_transaksi; ?>"onclick= "return confirm('yakin?');"   class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Konfimasi</a>
                                            </span>
                                        </div>
                                      </div>
                                    </div>
