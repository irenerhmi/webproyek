                                ...
                                <div class="card-body">
                                    <div class="col">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="tanggal" class="form-control" placeholder="Ketik disini..">
                                            <label for="">Isi Artikel</label>
                                            <textarea rows="40" type="text" name="artikel" class="form-control" placeholder="Ketik disini..."></textarea><br>
                                            <label class="form-label" for="customFile">Unggah Gambar untuk Artikel</label>
